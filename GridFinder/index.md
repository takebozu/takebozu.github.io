---
layout: default
title: GridFinder for iOS — Grid-Based Map Search
description: >-
  GridFinder shades your route onto a map grid as you walk, so you always
  know what you've searched and what's left.
...
# <img src="../img/icons/gridfinder_logo.png" height="32" align="top" alt="GridFinder icon"> GridFinder for iOS
...
<div style="display:flex; gap:12px; flex-wrap:wrap;">
  <img src="../img/screenshots/gridfinder/p1_en.png" alt="GridFinder screenshot: explored area shaded onto the map while searching" style="max-width:220px; width:100%; height:auto; border-radius:8px;">
  <img src="../img/screenshots/gridfinder/p2_en.png" alt="GridFinder screenshot: sharing a session code for collaborative search" style="max-width:220px; width:100%; height:auto; border-radius:8px;">
</div>
...
[Privacy Policy](./PrivacyPolicy-en.html) · [Support](../general/contact-en.html)
